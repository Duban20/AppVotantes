...
class votante(models.Model):
    ...
    nombre = models.CharField(max_length=100, verbose_name="Nombres", help_text="Ingrese los nombres del votante.")
    apellido = models.CharField(max_length=100, verbose_name="Apellidos", help_text="Ingrese los apellidos del votante.")
