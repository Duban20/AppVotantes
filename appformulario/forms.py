...
class VotanteForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'nombre': forms.TextInput(attrs={'placeholder': 'Ingrese los nombres de la persona','class': 'form-control'}),
            'apellido': forms.TextInput(attrs={'placeholder': 'Ingrese los apellidos de la persona','class': 'form-control'}),
            'cedula': forms.NumberInput(attrs={'placeholder': 'Número de cédula','class': 'form-control'}),
            ...
            'direccion_residencia': forms.TextInput(attrs={'placeholder': 'Dirección de residencia','class': 'form-control'}),
            'barrio_residencia': forms.TextInput(attrs={'placeholder': 'Barrio de residencia','class': 'form-control'}),
            'telefono': forms.NumberInput(attrs={'placeholder': 'Teléfono de contacto','class': 'form-control'}),
